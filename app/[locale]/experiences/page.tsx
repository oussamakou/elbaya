  ...
  return (
    <>
      <section className="relative flex min-h-[82vh] items-end overflow-hidden bg-dusk px-5 pb-20 text-cream">
        <Image src={img('movement_research_lab.jpeg')} alt="The Mouvement Research space at Farm El Baya" fill priority sizes="100vw" className="object-cover animate-breathe opacity-80" />
      ...
      <section className="px-5 py-24">
        <div className="mx-auto max-w-6xl">
          <div className="mb-10 max-w-2xl">
            <p className="text-xs font-semibold uppercase tracking-label text-bark">{locale === 'fr' ? 'Ce qui est inclus' : 'Included and available'}</p>
      ...
      <section className="bg-cream px-5 py-24">
        <div className="mx-auto max-w-6xl">
          <div className="mb-10 max-w-2xl">
            <p className="text-xs font-semibold uppercase tracking-label text-bark">{content.eventsHeading}</p>
