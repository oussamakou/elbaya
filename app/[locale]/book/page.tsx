...
export default async function Book({params}: {params: Promise<{locale: string}>}) {
  ...
  const facts = fr
    ? [
        ...
        {label: 'Inclus', value: 'Petit-déjeuner'},
        {label: 'Paiement', value: "À l'arrivée"},
        {label: 'Disponibilité', value: '3 chambres seulement'},
    ...
    <>
      ...
      <section className="px-5 py-14">
        <div className="mx-auto grid max-w-4xl gap-5 md:grid-cols-3">
          {(fr
            ? ['Envoyez vos dates et préférences', 'Mahdi propose la meilleure option disponible', 'Vous confirmez seulement si tout vous convient']
