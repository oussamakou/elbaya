    ...
    <>
      ...
      <section className="px-5 pt-12">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mt-3 max-w-xl text-sm leading-7 text-earth/70">
            {fr
        ...
        <div className="mx-auto grid max-w-4xl gap-5 md:grid-cols-3">
          {(fr
            ...
            <div key={step} className="border border-mist bg-cream p-5">
              <p className="text-xs font-semibold uppercase tracking-[0.2em] text-bark">{fr ? 'Étape' : 'Step'} {index + 1}</p>
      ...
      <section className="px-5 pb-8">
        <div className="mx-auto max-w-3xl rounded-[8px] border border-mist bg-earth p-8 text-center text-cream md:p-12">
          <p className="text-xs font-semibold uppercase tracking-[0.22em] text-terracotta">{fr ? 'Une question ?' : 'A question?'}</p>
          ...
          <p className="mx-auto mt-5 max-w-xl leading-8 text-cream/72">
            {fr
          ...
          <WhatsAppLink locale={locale} className="mt-8 inline-flex items-center justify-center rounded-full bg-terracotta px-7 py-4 text-sm font-semibold text-cream transition-[scale,background-color] duration-300 hover:bg-[#A8501C] active:scale-[0.96]">
