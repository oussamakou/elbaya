...
export default function Footer() {
  ...
  const links = locale === 'fr'
    ? [['/stay', 'Séjour'], ['/farm', 'La ferme'], ['/products', 'La boutique'], ['/experiences', 'Expériences'], ['/guides', 'Guides'], ['/book', 'Réserver']]
    : [['/stay', 'Stay'], ['/farm', 'The Farm'], ['/products', 'Farm shop'], ['/experiences', 'Experiences'], ['/guides', 'Guides'], ['/book', 'Book']];
