...
export default function Footer() {
  ...
  const links = locale === 'fr'
    ? [['/stay', 'Séjour'], ['/farm', 'La ferme'], ['/products', 'Boutique'], ['/experiences', 'Expériences'], ['/guides', 'Guides'], ['/book', 'Réserver']]
    : [['/stay', 'Stay'], ['/farm', 'The Farm'], ['/products', 'Shop'], ['/experiences', 'Experiences'], ['/guides', 'Guides'], ['/book', 'Book']];
