const policies = {
  en: [
    ...
    ['Meals', 'Farm breakfast on request (20 DT / €6). Lunch and dinner on request (40 DT / €12 each), confirmed before arrival.'],
  ...
  fr: [
    ...
    ['Repas', "Petit-déjeuner de la ferme sur demande (20 DT / 6 €). Déjeuner et dîner sur demande (40 DT / 12 € chacun), confirmés avant l'arrivée."],
