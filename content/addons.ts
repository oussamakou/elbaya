...
const catalogs: Record<SupportedLocale, Addon[]> = {
  en: [
    ...
    {id: 'training', category: 'experiences', title: 'Movement session with Mahdi', description: 'A personalized movement and wellness session with Mahdi.', price: '85 DT / €26 per guest, per stay', experienceLabel: 'Arrange ahead'},
    ...
    {id: 'olive-harvest', category: 'experiences', title: 'Olive harvest', description: 'Join the family harvest from December to February. Olive oil is available separately.', price: '85 DT / €26 per guest, per stay', experienceLabel: 'December to February'},
    {id: 'cooking', category: 'experiences', title: 'Cooking with the family', description: 'Prepare bread and local dishes around the open-air kitchen; the shared meal is included.', price: '85 DT / €26 per guest, per stay', experienceLabel: 'Arrange ahead'},
  ...
  fr: [
    ...
    {id: 'training', category: 'experiences', title: 'Séance de mouvement avec Mahdi', description: 'Une séance personnalisée de mouvement et de bien-être avec Mahdi.', price: '85 DT / 26 € par personne et par séjour', experienceLabel: 'À organiser'},
    ...
    {id: 'olive-harvest', category: 'experiences', title: 'Récolte des olives', description: 'Participez à la récolte familiale de décembre à février. L’huile d’olive est disponible séparément.', price: '85 DT / 26 € par personne et par séjour', experienceLabel: 'Décembre à février'},
    {id: 'cooking', category: 'experiences', title: 'Cuisine en famille', description: 'Préparez le pain et des plats locaux autour de la cuisine extérieure ; le repas partagé est inclus.', price: '85 DT / 26 € par personne et par séjour', experienceLabel: 'À organiser'},
